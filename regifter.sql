...
INSERT INTO gifts (gift, giver, value, previously_regifted)
VALUES
('fabbulous candle', 'chow', '7', FALSE),
('hurry candle', 'chow', '12', TRUE),
('mahr', 'shaq', '350000', FALSE),
('justice', 'cratr', '1', FALSE),
('not mango candle', 'not the Boss', '50', FALSE)
;
...
-- 
UPDATE gift SET value = 2999 WHERE id = 2 RETURNING *;
